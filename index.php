<?php
    ...
    $aboutRow = $about->fetch_array();

    $contact = $connection->query("SELECT * FROM contact");
    $contactRow = $contact->fetch_array();
?>
...
<head>
     ...
     <!-- MAIN CSS -->
     <link rel="stylesheet" href="website-assets/css/tooplate-gymso-style.css">
...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html">O-GHIMS</a>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Upgrade your body at <br>O-GHIMS</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                    <h2 class="mb-3 text-white" data-aos="fade-up">New to the O-GHIMS?</h2>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-lg-12 col-12 text-center mb-5">
                        <h2 data-aos="fade-up" data-aos-delay="200">Announcements</h2>
                        </div>
                    <?php
                        $announcement = $connection->query("SELECT * FROM announcement");
                        while($announcementRow = $announcement->fetch_array()){
                    ?>
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                        <div class="class-thumb">
                            <div class="class-info">
                                <h3 class="mb-1"><?= $announcementRow['title'] ?></h3>

                                <p class="mt-3"><?= $announcementRow['description'] ?></p>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
               ...
               <div class="container">
                    <div class="row">
                        ...
                        <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                            <h2 class="mb-4" data-aos="fade-up" data-aos-delay="300">Mission</h2>

                            <p data-aos="fade-up" data-aos-delay="400"><?= $aboutRow['mission']; ?></p>
                        ...
                        <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                                ...
                                <p data-aos="fade-up" data-aos-delay="400"><?= $aboutRow['vision']; ?></p>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="mx-auto mt-4 mt-lg-0 mt-md-0 col-lg-5 col-md-6 col-12">
                        ...
                        <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i> <?= $aboutRow['gym_address']; ?></p>
...
-->
               ...
               <div class="row">
                    ...
                    <div class="d-flex justify-content-center mx-auto col-lg-5 col-md-7 col-12">
                        <p class="mr-4">
                            ...
                            <a href="#"><?= $contactRow['email']; ?></a>
                        </p>

                        <p><i class="fa fa-phone mr-1"></i> <?= $contactRow['contact_no']; ?></p>
                    </div>
    ...
    <div class="modal fade" id="membershipForm" tabindex="-1" role="dialog" aria-labelledby="membershipFormLabel" aria-hidden="true">
     ...
     <script src="website-assets/js/smoothscroll.js"></script>
